const NewsLatterBox = () => {
  return (
    <div
      className="h-full wow fadeInUp relative z-10 rounded-lg bg-[#fffff5] p-8 sm:p-11 lg:p-8 xl:p-11 shadow-lg"
      data-wow-delay=".2s"
    >
      ...
      Stay informed with the latest updates and news—subscribe now!
      </p>
      <form>
        <input
          type="text"
          ...
          className="mb-4 w-full rounded-md border border-body-color border-opacity-25 py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-body-color focus:border-opacity-100 focus-visible:shadow-none bg-[#fffff5]"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="duration-80 mb-4 w-full cursor-pointer rounded-md border border-transparent bg-black py-3 px-6 text-center text-base font-medium text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
