              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-6 text-body-color hover:text-black"
                  >
                    <svg
                      width="9"
                      height="18"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/blog"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-black"
                    >
                      {" "}
                      Latest Blogs{" "}
                    </a>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    ...
                    >
                      {" "}
                      MQ International Schooling<br />
                      Near Khilar Juma Masjid,<br />
                      Arikady Kunnil, Kumbla Post,<br />
                      Kasaragod<br />
                      671321<br />
                      {" "}
                    </a>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base">
              developed & maintained by <a href="https://acmeflare.in" target="_blank">Acmeflare Technologies</a>
            </p>
          </div>
        </div>
